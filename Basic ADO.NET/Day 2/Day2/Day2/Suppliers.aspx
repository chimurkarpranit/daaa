...
<div class="Center">
    <form id="form1" runat="server">
        <asp:GridView ID="gvSupplier" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging="OnPageIndexChanging" PageSize="5" Height="439px" style="margin-bottom: 61px" Width="986px">
